...
namespace ConsoleApp
{
    internal class Program
    {
        ...
        private static void ApiExample()
        {
            ...
            try
            {
                sales = App.GetDatabaseByName(databaseName);
            ...
            if (sales != null)
            {
                ...
                if (App.GetDatabaseById(salesId) is null)
                {
            ...
            try
            {
                databaseTables = App.GetDatabaseTables(sales);
            }
            catch (ArgumentException e)
            {
            ...
            try
            {
                usersTable = App.GetTableByName(sales, "Users");
                customersTable = App.GetTableByName(sales, "Customers");
                ordersTable = App.GetTableByName(sales, "Orders");
            }
            catch (ArgumentException e)
            {
            ...
            ordersTable = App.GetTableById(ordersTable.Id);
            ...
            if (usersTable != null)
            {
                ...
                if (App.GetTableById(tableId) is null)
                {
            ...
            try
            {
                otherAttribute = App.GetAttributeByName(ordersTable, "Other");
            }
            catch (ArgumentException e)
            {
            ...
            try
            {
                salesLinks = App.GetDatabaseLinks(sales);
            }
            catch (ArgumentException e)
            {
